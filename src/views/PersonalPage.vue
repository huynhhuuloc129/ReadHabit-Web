                    ...
                    <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                      <form @submit="onUpdateUser" class="row gy-3 gy-xxl-4">
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <input v-model="updateUserForm.firstName" type="text" class="form-control" id="inputFirstName" required>
                        </div>
                        <div class="col-12 col-md-6">
                          <label for="inputLastName" class="form-label">Họ</label>
                          <input v-model="updateUserForm.lastName" type="text" class="form-control" id="inputLastName" required>
                        </div>
                        <div class="col-12 col-md-6">
                          <label for="inputPhone" class="form-label">Số điện thoại</label>
                          <input v-model="updateUserForm.phoneNumber" type="tel" class="form-control" id="inputPhone" required>
                        </div>
                        <div class="col-12 col-md-6">
                          <label for="inputYouTube" class="form-label">YouTube</label>
                          <input v-model="updateUserForm.youtubeLink" type="text" class="form-control" id="inputYouTube" >
                        </div>
                        <div class="col-12 col-md-6">
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <input v-model="updateUserForm.facebookLink" type="text" class="form-control" id="inputFacebook">
                        </div>
                        <div class="col-12 col-md-6">
                          <label for="inputLinkedIn" class="form-label">LinkedIn</label>
                          <input v-model="updateUserForm.linkedinLink" type="text" class="form-control" id="inputLinkedIn">
                        </div>
                        <div class="col-12">
                      ...
                      <form @submit = 'onUpdatePassword'>
                        <div class="row gy-3 gy-xxl-4">
                          ...
                          <div class="col-12">
                            ...
                            <input v-model="repeatNewPassword" type="password" class="form-control" id="confirmPassword" required>
                          </div>
                          <div class="col-12">
                            <button type="submit" class="btn btn-primary bg-main">Thay đổi mật khẩu</button>
                          </div>
                        </div>
                        <div v-if="showUpdatePasswordFail" class="alert alert-danger" role="alert" style="margin-top: 10px;">
                          Cập nhật mật khẩu không thành công, vui lòng kiểm tra lại các trường!
                        </div>
                        <div v-if="showUpdatePasswordSuccess" class="alert alert-success" role="alert" style="margin-top: 10px;">
