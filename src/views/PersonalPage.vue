            ...
            <div class="row gy-4">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush mb-4">
                      <li class="list-group-item d-flex justify-content-between align-items-center w-100">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#followerModal" @click="getFollow">{{
                          user.totalFollower }}</a>

                        <!-- Modal -->
                        <div v-if="isLogin && user.totalFollower > 0" class="modal fade" id="followerModal"
                          tabindex="-1" aria-labelledby="followerModalLabel" aria-hidden="true">
                                ...
                                <div v-for="follower in followerOfUsers" :key="follower.id"
                                  ...
                                  <div v-if="follower.follower.id != currentUser.id">
                                    <button v-if="trackingFollowArr.get(follower.follower.id) == true"
                                      class="btn btn-primary" @click="unFollow(follower.follower.id)">
                                      Đã theo dõi
                                    </button>
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center w-100">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#followingModal" @click="getFollow">{{
                          user.totalFollowee }}</a>

                        <!-- Modal -->
                        <div v-if="isLogin && user.totalFollowee > 0" class="modal fade" id="followingModal"
                          tabindex="-1" aria-labelledby="followingModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                ...
                                <div v-for="following in followingOfUsers" :key="following.id"
                                  ...
                                  <div v-if="following.followee.id != currentUser.id">
                                    <button v-if="trackingFollowArr.get(following.followee.id) == true"
                                      class="btn btn-primary" @click="unFollow(following.followee.id)">
                                      Đã theo dõi
                                    </button>
                                    <button v-else class="btn btn-outline-primary"
              ...
              <div class="col-12">
                <div class="card widget-card border-light shadow-sm">
                  ...
                  <div class="card-body">
                    <a :href="user.youtubeLink" class="d-inline-block bg-dark link-light lh-1 p-2 rounded mx-2">
                    ...
                    <a :href="user.twitterLink" class="d-inline-block bg-dark link-light lh-1 p-2 rounded mx-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a :href="user.facebookLink" class="d-inline-block bg-dark link-light lh-1 p-2 rounded mx-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a :href="user.linkedinLink" class="d-inline-block bg-dark link-light lh-1 p-2 rounded mx-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="card widget-card border-light shadow-sm">
                  ...
                  <div class="card-body">
                    ...
                    <div class="modal fade" id="categoryModalEdit" tabindex="-1"
                      aria-labelledby="categoryModalEditLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-body">
                            <div class="d-flex flex-column" style="margin-top: 10px">
                              <div class="form-check" v-for="(category, index) in categories" :key="category.id">
                                <input v-model="trackingCategory[categories[index].id]" class="form-check-input"
                                  type="checkbox" value="" :id="category.id + 'category'" />
                                <label class="form-check-label" :for="category.id + 'category'">
                                  {{ category.name }}
                                </label>
                              </div>
                            </div>
                            <button @click="updateCategory()" class="btn btn-primary w-100" style="margin-top: 10px">
                              Cập nhật
                            </button>
                          </div>
                        </div>
            ...
            <div class="card widget-card border-light shadow-sm">
              <div class="card-body p-4">
                <ul class="nav nav-tabs" id="profileTab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="rank-tab" data-bs-toggle="tab" data-bs-target="#rank-tab-pane"
                      type="button" role="tab" aria-controls="rank-tab-pane" aria-selected="false">
                      Xếp hạng
                    </button>
                  </li>
                </ul>
                <div class="tab-content pt-4" id="profileTabContent">
                  ...
                  <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
                    ...
                    <form @submit="onUpdateUser" class="row gy-3 gy-xxl-4">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <input v-model="updateUserForm.youtubeLink" type="text" class="form-control"
                          id="inputYouTube" />
                      </div>
                      <div class="col-12 col-md-6">
                        <label for="inputX" class="form-label">X</label>
                        <input v-model="updateUserForm.twitterLink" type="text" class="form-control" id="inputX" />
                      </div>
                      <div class="col-12 col-md-6">
                        <label for="inputFacebook" class="form-label">Facebook</label>
                        <input v-model="updateUserForm.facebookLink" type="text" class="form-control"
                          id="inputFacebook" />
                      </div>
                      <div class="col-12 col-md-6">
                        <label for="inputLinkedIn" class="form-label">LinkedIn</label>
                        <input v-model="updateUserForm.linkedinLink" type="text" class="form-control"
                          id="inputLinkedIn" />
                      </div>
                      <div class="col-12">
                    ...
                    <div v-if="showUpdateUserSuccess" class="alert alert-success" role="alert" style="margin-top: 10px">
                    ...
                    <form @submit="onUpdatePassword">
                      <div class="row gy-3 gy-xxl-4">
                        ...
                        <div class="col-12">
                          ...
                          <input v-model="repeatNewPassword" type="password" class="form-control" id="confirmPassword"
                            required />
                        </div>
                        <div class="col-12">
                      ...
                      <div v-if="showUpdatePasswordFail" class="alert alert-danger" role="alert"
                        style="margin-top: 10px">
                        Cập nhật mật khẩu không thành công, vui lòng kiểm tra lại các trường!
                      </div>
                      <div v-if="showUpdatePasswordSuccess" class="alert alert-success" role="alert"
                        style="margin-top: 10px">
                  ...
                  <div class="tab-pane fade" id="post-tab-pane" role="tabpanel" aria-labelledby="post-tab" tabindex="0">
                    <h6 class="mb-1">Tóm tắt</h6>
                    <p class="mb-1">Tổng số bài viết đã viết: {{ posts.length }}</p>
                    ...
                    <div v-for="(bookmark, index) in bookmarks" :key="bookmark.id">
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                          ...
                          <!-- Modal -->
                          <div class="modal fade" :id="'editBookmarkModel' + bookmark.id" tabindex="-1"
                            aria-labelledby="editBookmarkModelLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                <div class="modal-header">
                        ...
                        <button v-if="index > 0" class="btn btn-danger" data-bs-toggle="modal"
                        ...
                        <!-- Modal -->
                        <div class="modal fade" :id="'deleteBookmark' + bookmark.id" tabindex="-1"
                      ...
                      <div v-if="bookmark.bookmarkPosts != null && bookmark.bookmarkPosts.length > 0"
                        ...
                        <button @click="postVisibles[index] += steps[index]"
                          v-if="postVisibles[index] < trackingBookmarkPost[index].length" class="btn moreBtn" style="
                            width: 31%;
                            border-radius: 50px;
                  ...
                  <div v-if="currentRank != null" class="tab-pane fade" id="rank-tab-pane" role="tabpanel"
