<template>
  <Suspense>
        ...
        <nav id="sidebarMenu" style="z-index: 0;" class="bg-white sticky-top">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    <a href="#" class="list-group-item list-group-item-action py-2 ripple active" aria-current="true" data-bs-toggle="tab" data-bs-target="#dashboard">
                        <i class="fas fa-chart-line fa-fw me-3"></i>
                        <span>Bảng thống kê</span>
                    </a>
                    <a href="#" class="list-group-item list-group-item-action py-2 ripple " aria-current="false" data-bs-toggle="tab" data-bs-target="#post" aria-controls="post">
                        <i class="fa-solid fa-newspaper fa-fw me-3"></i>
                        <span>Bài viết</span>
                    </a>

                    
                    <a href="#" class="list-group-item list-group-item-action py-2 ripple" aria-current="false" data-bs-toggle="tab" data-bs-target="#users" aria-controls="users">
                        <i class="fa-solid fa-users fa-fw me-3"></i>
                        <span>Người dùng</span>
                    </a>
                    <a href="#" class="list-group-item list-group-item-action py-2 ripple" aria-current="false" data-bs-toggle="tab" data-bs-target="#" aria-controls="asdf">
                    ...
                    <a href="#" class="list-group-item list-group-item-action py-2 ripple" aria-current="false" data-bs-toggle="tab" data-bs-target="#" aria-controls="asdf"><i class="fas fa-users fa-fw me-3">
                        </i><span>Users</span>
                    </a>
                    <a href="#" class="list-group-item list-group-item-action py-2 ripple" aria-current="false" data-bs-toggle="tab" data-bs-target="#" aria-controls="asdf">
    ...
    <div class="tab-content" id="v-pills-tabContent">
        <div class="tab-pane fade show active mt-4" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab" style="width: 80vw;">
                ...
                <div class="container mt-4 px-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive table-borderless">
                            ...
                            <td>{{ post.type }}</td>
                            <td>{{ post.title }}</td>
                            <td><img style="border-radius: 50%; margin-right: 5px" :src="'http://localhost:8080' + post.createdBy.avatar.replace('files', '')" width="25" height="25">{{ post.createdBy.fullName }}</td>
                ...
                <div class="container mt-5 px-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-responsive table-borderless">
                            ...
                            <td>{{ post.type }}</td>
                            <td>{{ post.title }}</td>
                            <td class="align-items-center"><img style="border-radius: 50%; margin-right: 5px" :src="'http://localhost:8080' + post.createdBy.avatar.replace('files', '')" width="25" height="25">{{ post.createdBy.fullName }}</td>
