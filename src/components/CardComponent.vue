<template>
                    ...
                    <div class="card text-dark card-has-bg click-col"
                        ...
                        <div class="card-img-overlay d-flex flex-column">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mt-0 "><a class="text-dark fw-bold" herf="https://creativemanner.com">Web
  ...
  <div class="row">
    <div class="col-sm-12 col-md-6 col-lg-4 mb-4" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
...
.visit-btn:before,
.visit-btn:after,
.visit-btn span:before,
.visit-btn span:after {
    content: '';
...
.visit-btn:hover span:before,
.visit-btn:hover span:after {
    opacity: 1;
    visibility: visible;
}
