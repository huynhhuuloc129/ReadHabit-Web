<template>
  <section class="">
    <div class="container">
      <div class="row" style="width: 60vw"></div>
      <div class="row">
        <div v-for="post in props.posts" :key="post.id" class="col-sm-12 col-md-6 col-lg-4 mb-4"
          ...
          <div class="card post text-dark card-has-bg click-col"
            :style="{ 'background-image': 'url(' + (post.imageURL != null && post.imageURL != '' ? post.imageURL :  'https://cdn.tuoitre.vn/thumb_w/640/2020/5/22/bao-chi-15901455050011246995406.jpg') + ')' }">
          ...
          <div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
            ...
            <h6 v-if="post.category != null" class="text-secondary text-uppercase" style="margin-left: 20px">
              {{ post.category.name }}
            </h6>
            <div class="offcanvas-body">
              <div class="row" style="margin-bottom: 20px">
                ...
                <div class="col-6" style="word-wrap: break-word">
                  ...
                  <div style="margin-top: 10px">{{ post.readTime }} phút</div>
                  <div style="margin-top: 10px">
                    {{ post.createdAt.slice(0, 10) }}
                  </div>
                  <div style="margin-top: 10px">{{ post.totalLike }} lượt</div>
